...
from tests.testlibraries.instance_resource import (
    ...
    FILE_JSON_EPISODE_DATA_EXAMPLE_01,
    FILE_JSON_EPISODE_DATA_EXAMPLE_02,
    FILE_JSON_EPISODE_DATA_EXAMPLE_03,
    InstanceResource,
)
...
class TestEpisodeLoader:
    ...
    def test__list_up_episode(requests_mock, tmp_path):
        ...
        program_id_string = "tgs"
        with (tmp_path / f"{program_id_string}.yml").open("w", encoding="UTF-8", newline="\n") as file_backup:
